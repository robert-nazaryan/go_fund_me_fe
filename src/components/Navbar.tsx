      ...
      <nav className="navbar">
        <div className="navbar-container">
          <Link to="/" className="navbar-logo">
            <svg className="logo-icon" width="36" height="36" viewBox="0 0 90 90" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="navbar-menu">
            ...
            {isAuthenticated ? (
                <>
                  <Link to="/campaigns" className="navbar-link">{t.navbar.campaigns}</Link>
